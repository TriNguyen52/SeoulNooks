...
SECRET_KEY = 'django-insecure-!w_5+y4gud8o7tj^j0duzih(29+(+2h^wrmahba8#lsyv*p!9o'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'guesswhat793@gmail.com'  # Replace with your email
EMAIL_HOST_PASSWORD = 'rpfp jgia akef pmur'  # Use environment variables for security
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "crm/templates"],  # Add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
